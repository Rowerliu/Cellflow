...
def load_source_data_for_domain_transition(
        *,
        batch_size,
        image_size,
    ...
    """
    This function is new in DDIBs: loads the source dataset for transition.
...
def get_image_filenames_for_label(label):
    ...
    function for ImageNet transition experiments.
