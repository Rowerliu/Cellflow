...
def main():
    ...
    folder = os.path.join(rf'F:\BUAA\02_Code\02_ZhangLab\08_process-learning-V2\01_results\20231111_ROSE_Neg2Pos_TTFF_ddim100_a10')
    ...
    source_dir = r'F:\BUAA\02_Code\02_ZhangLab\01_guided-diffusion-lzy\02_results_saved\20231028_ROSE_Neg_Blur_384-256\True\model'
...
def create_argparser(type=None):
    defaults = dict(
        data_dir=r"G:\12_Data\03_Pathology\08_Process-Learning\01_ROSE\02_test\Negative_256_120",
        image_size=256,
        batch_size=1,
    )
