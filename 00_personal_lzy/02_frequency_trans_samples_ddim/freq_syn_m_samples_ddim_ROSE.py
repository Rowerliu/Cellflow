...
def main():
    ...
    folder = os.path.join(rf'E:\BUAA\02_Code\02_ZhangLab\08_ADD\08_process-learning-V2\02_results_saved\20240516_ROSE_transition\neg2pos_2_a1')
    ...
    source_dir = r'E:\BUAA\02_Code\02_ZhangLab\01_guided-diffusion-lzy\02_results_saved\20231028_ROSE_r384-256_Blur_100000\20231028_ROSE_Neg_Blur_384-256\True\model'
    source_model, diffusion = read_model_and_diffusion(args_source, source_dir)

    target_dir = r'E:\BUAA\02_Code\02_ZhangLab\01_guided-diffusion-lzy\02_results_saved\20231028_ROSE_r384-256_Blur_100000\20231028_ROSE_Pos_Blur_384-256\False\model'
...
def create_argparser(type=None):
    defaults = dict(
        data_dir=r"F:\12_Data\03_Pathology\01_ROSE\01_Rose\fewshot_learning\rose_256\s2",
        image_size=256,
        batch_size=1,
    )
    ...
    parser.add_argument(
            ...
            type=int,
            default=0,
            help="Source dataset ROSE neg."
        )
    parser.add_argument(
            "--target",
            type=int,
            default=1,
            help="Target dataset ROSE pos."
    )
