...
def main():
    ...
    folder = os.path.join(rf'F:\BUAA\02_Code\02_ZhangLab\08_process-learning-V2\01_results\20231225_pRCC_Type1-2_r512_TTFF_ddim\ddim100_a10\mil-train')
    ...
    source_dir = r'F:\BUAA\02_Code\02_ZhangLab\01_guided-diffusion-lzy\02_results_saved\20231212_pRCC_r768-512_Blur_100000\Type1\True\model'
    source_model, diffusion = read_model_and_diffusion(args_source, source_dir, synthetic=False)

    target_dir = r'F:\BUAA\02_Code\02_ZhangLab\01_guided-diffusion-lzy\02_results_saved\20231212_pRCC_r768-512_Blur_100000\Type2\False\model'
...
def create_argparser(type=None):
    defaults = dict(
        data_dir=r"G:\12_Data\03_Pathology\02_pRCC\02_resize\512\train\data\1",
        image_size=512,
        batch_size=1,
    )
