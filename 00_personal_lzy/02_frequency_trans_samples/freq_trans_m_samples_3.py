...
def main():
    ...
    folder = os.path.join(rf'F:\BUAA\02_Code\02_ZhangLab\08_process-learning-V2\01_results\20231101_ROSE_FFTT')
    ...
    target_dir = r'F:\BUAA\02_Code\02_ZhangLab\01_guided-diffusion-lzy\02_results_saved\20231028_ROSE_Pos_Blur_384-256\True\model'
