...
def main():
    ...
    image_folder = r'E:\LZY\02_ddib_lzy\01_results_4'
...
def create_argparser():
    defaults = dict(
        ...
        numpy_dir=r'E:\LZY\10_diffusion_latent_trans\02_results_saved\20230804_HE2IHC_sample64_ts990\output\output.npy',
        image_size=256,
        batch_size=2,
    )
