...
def main():
    ...
    folder = r'F:\BUAA\02_Code\02_ZhangLab\02_ddib_lzy\01_results'
    pathlib.Path(folder).mkdir(parents=True, exist_ok=True)

    time_start = datetime.datetime.now().strftime('%Y-%m-%d %H-%M-%S')
    logger.configure(dir=folder, log_suffix=time_start)
    logger.log("Title: " + "Transfer latent images")
    ...
    target_dir = r'F:\BUAA\02_Code\02_ZhangLab\02_ddib_lzy\03_models\01_BCI_True\IHC'
    # target_dir = r'F:\BUAA\02_Code\21_Diffusion\07_guided-diffusion-main\02_results_saved\20230806_BCI_IHC_384-256\model'
...
def create_argparser():
    defaults = dict(
        ...
        numpy_dir=r'F:\BUAA\02_Code\02_ZhangLab\02_ddib_lzy\02_results_saved\20230817_BCI_HE2IHC_test_s120_c256_2step\all\combined_array.npy',
        image_size=256,
        batch_size=4,
    )
